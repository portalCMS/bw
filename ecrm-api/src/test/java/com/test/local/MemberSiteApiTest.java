...
//		apiTest.test();
	...
	public  void playHG(){
		try {
			String url = "http://192.168.1.187:8081/ecrm-api/Game/play?enterprisecode=EN0044";
			String params = "gametype=HGGame&playtype=&employeecode=E000K4PE&brandcode=EB0000BS&homeurl=http://dfh.play8.asia&lobbyurl=http://dfh.play8.asia&depositurl=http://dfh.play8.asia/membe";
			String aesparams= Encrypt.AESEncrypt(params,AES_KEY_EN0044);
			url += "&signature="+Encrypt.MD5(params+MD5_KEY_EN0044)+"&params="+aesparams;	
			System.out.println("进入游戏:"+url);
		} catch (Exception e) {
			e.printStackTrace();	
		}
	...
	public  void getVerifycode(){
		try {
			...
			String params = "brandcode=EB00001M&phoneno=18201602264";
			String aesparams= Encrypt.AESEncrypt(params, "VUhEndOteNSQDAAK");
			url += "&signature="+Encrypt.MD5(params+"Yb0caH3KBSv0j1sq")+"&params="+aesparams;
