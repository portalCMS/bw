...
public class CreditH5Controller extends BaseController{
	...
	private static List<String> ALL_AGENTTYPE = new ArrayList<String>() {
		private static final long serialVersionUID = 1943695420949560458L;
		{
	...
	public String login(HttpServletRequest request){
		try {
			...
			if( !ee.getEmployeetypecode().equals(Type.代理.value) && !ee.getEmployeetypecode().equals(Type.大股东.value)
					&& !ee.getEmployeetypecode().equals(Type.股东.value) && !ee.getEmployeetypecode().equals(Type.总代理.value)
					&& !ee.getEmployeetypecode().equals(Type.信用代理.value)){
...
//			#{total_stream_money,mode=OUT,jdbcType=DECIMAL}
	...
	public String myAgentList(HttpServletRequest request, HttpSession session) {
		try {
			...
			if (!employee.getEmployeetypecode().equals(EnterpriseEmployeeType.Type.业主.value) && 
