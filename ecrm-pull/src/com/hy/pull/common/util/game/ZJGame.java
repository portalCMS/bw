 ...
 */
public class ZJGame {
	private static Logger logger = LogManager.getLogger(ZJGame.class.getName());
	/**
	 ...
	 */
	public static List<Map<String, Object>> getZJData(String apiUrl,String agent,String userKey,String flag,String code)throws Exception {
...
//		String url = "http://zjapi.cg8080.com/zhouji/app/api.do";
		...
		String data = ZJUtil.gameinfo(userKey, apiUrl,flag);
		//System.out.println(data);
		Map<String,Object> info = JsonToMap.parseJSON2Map(data);
		...
		if(info.get("recordList") != null){
			...
			if(null!=result && result.size()>0){
				list.addAll(getZJData(code, result));
			}
		}
		return list;
	}
	...
	public static void main(String[] arg){
		try {
			System.out.println(getZJData("http://testzjxy.cg6188.com/zhouji/app/api.do","lilongtest","lilongtest_582a1d68-e662-43c3-9876-0",null,""));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
