...
public class DateUtil {
    ...
    public static Date getStr2Date(String dateStr,String format){
    	SimpleDateFormat sdf =new SimpleDateFormat(format);
    	try {
    ...
    public static String format(Date date,String tz,String format){
		SimpleDateFormat sdf =new SimpleDateFormat(format);
...
//    	String yestoday4 = DateUtil.parse(DateUtil.add(new Date(), Calendar.DATE, -6), "yyyy-MM-dd");//两周内
    	...
    	System.out.println(format(new Date(), "GMT+0", "yyyy-MM-dd HH:mm:ss"));
	}
