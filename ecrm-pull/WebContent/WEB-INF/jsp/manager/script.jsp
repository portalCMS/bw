...
<script src="${pageContext.request.contextPath }/resource/vendors/jquery-news-ticker/jquery.newsTicker.min.js"></script> 
<script src="${pageContext.request.contextPath }/resource/vendors/moment/moment.js"></script> 
<script src="${pageContext.request.contextPath }/resource/vendors/bootstrap-datepicker/js/bootstrap-datepicker.js"></script> 
<script src="${pageContext.request.contextPath }/resource/vendors/bootstrap-daterangepicker/daterangepicker.js"></script> 
<script src="${pageContext.request.contextPath }/resource/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
<!--CORE JAVASCRIPT--> 
<script src="${pageContext.request.contextPath }/resource/js/main.js"></script> 
<!--LOADING SCRIPTS FOR PAGE--> 
<%-- <script src="${pageContext.request.contextPath }/resource/vendors/intro.js/intro.js"></script>  --%>
<%-- <script src="${pageContext.request.contextPath }/resource/vendors/calendar/zabuto_calendar.min.js"></script>  --%>
<%-- <script src="${pageContext.request.contextPath }/resource/vendors/sco.message/sco.message.js"></script>  --%>
<%-- <script src="${pageContext.request.contextPath }/resource/js/index.js"></script> --%>
<script src="${pageContext.request.contextPath }/resource/js/public.js?v=8"></script>
