	...
	<div class="page-content">
		<div id="table-action" class="row">
			...
			<div class="panel panel-yellow">
					<div class="panel-heading">HG真人游戏数据</div>
					<div class="panel-body pan">
						<div class="form-body pal">
							<form id="HGGameForm" name="HGGameForm">
								<input type="hidden" name="GAME_ID" value="40" /> <input type="hidden" name="type" value="HGL" />
								<div class="row">
									<%-- <div class="col-md-4">
									...
									<div class="col-md-12">
										<div class="form-group">
											<button type="button" class="btn btn-primary" onclick="pullData('HGGameForm')">马上拉取</button>
										</div>
									</div>
			...
			<div class="panel panel-yellow">
					<div class="panel-heading">KG彩票游戏数据</div>
					<div class="panel-body pan">
						<div class="form-body pal">
							<form id="KGGameForm" name="KGGameForm">
								<input type="hidden" name="GAME_ID" value="38" /> <input type="hidden" name="type" value="KGL" />
								<div class="row">
									<%-- <div class="col-md-4">
										<div class="form-group">
											<label for="PROXY_ID" class="control-label">所属代理</label> <select id="PROXY_ID" class="form-control" name="PROXY_ID">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="SABEGIN_DATE" class="control-label">开始日期</label> <input id="SABEGIN_DATE" name="BEGIN_DATE" type="text" placeholder="" class="form-control" maxlength="20" />
											<label for="loginaccount" class="control-label"><font color="red">开始日期分钟必须是10的倍数(格式如：2018-06-06 10:10)</font></label>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="SAEND_DATE" class="control-label">结束日期</label> <input id="SAEND_DATE" name="END_DATE" type="text" placeholder="" class="form-control" maxlength="20" />
										</div>
									</div>

									<div class="col-md-12">
										<div class="form-group">
											<button type="button" class="btn btn-primary" onclick="pullData('KGGameForm')">马上拉取</button>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		function pullData(formName) {
			...
			if (formName == "tagForm") {
				...
				title = "波音EVEB游戏";
			} else if (formName == "KGGameForm") {
				title = "KG彩票";
			}else if (formName == "HGGameForm") {
				title = "HG真人";
			}
