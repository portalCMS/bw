...
//    	System.out.println("MD5加密原文："+str.toString().concat(MD5_KEY));
    ...
    public static String encrypt(String deskey, String input) { 
    	try {
    ...
    public static void main(String args[]) { 
        try { 
            ...
            String p=encrypt("00837104b7285090", "method=VerifyUsername&Key=D4542CFAA60D4940ABFDA9D753BA5CDF&Time=20161205143613&Username=xiaogao"); 
