...
public class IBCEGameAPI implements BaseInterface {
	...
	private String OpCode = "51BAOWCN";
	private String PrivateKey = "CJEDNB73DGH2S95FJ3";
	private String Domain = "51baowang.net";
	private String CnameDomain = "http://api.51baowang.net";//该参数用于决定用什么域名进入EIBCController，因为要在这里面写cookies。类似于支付域名
...
//				5  美国的赔率
				...
				if(object.has("code") && object.getString("code").equals("1001")) {
					...
					if( object.getString("error_code").equals("0") || object.getString("error_code").equals("22005")) {
