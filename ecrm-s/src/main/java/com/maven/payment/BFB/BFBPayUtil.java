...
public class BFBPayUtil {
	...
	public static boolean checkSign(Map<String, Object> params, String shalKey) {
		String signed_msg = params.get("SIGNED_MSG").toString();
		params.remove("SIGNED_MSG");
		String sign = Encrypt.MD5(BFBPayMent.buildSignStr(params)+shalKey);
		System.out.println("加密前参数"+BFBPayMent.buildSignStr(params));
		System.out.println("=========signed_msg:"+signed_msg+"/t/tsign:"+sign);
		if (sign.equals(signed_msg)) {
			return true;
		}
		return false;
	}
	public static String toBFBAmount(BigDecimal amount){
	...
	public static void main(String[] args) {
		...
		String jiamiStr = BFBPayMent.buildSignStr(paramsMap)+"4944ab75bb2b2e6c";
		System.out.println(Encrypt.MD5(jiamiStr));

		BigDecimal amount =  new BigDecimal("300.03");
		System.out.println(String.valueOf(amount.multiply(new BigDecimal("100")).intValue()));
		
		String m = "100.03";
		String m3 = "300.33";
		Double d1 = Double.valueOf(m)*100;
		Double d2 = Double.valueOf(m3)*100;
