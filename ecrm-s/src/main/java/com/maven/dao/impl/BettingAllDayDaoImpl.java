...
public class BettingAllDayDaoImpl extends BaseDaoImpl<BettingAllDay> implements BettingAllDayDao{
	 ...
	 */
	@Override
	public void deleteRecordBatch(String betDate) {
		 getSqlSession().insert("BettingAllDay.deleteRecordBatch", betDate);
	}
	@Override
	public void updateStatusAllDayByBetDate(String betDate) {
		getSqlSession().insert("BettingAllDay.updateStatusAllDayByBetDate", betDate);
	}
}
