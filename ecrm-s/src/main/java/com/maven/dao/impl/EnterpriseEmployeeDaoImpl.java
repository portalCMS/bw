...
public class EnterpriseEmployeeDaoImpl extends BaseDaoImpl<EnterpriseEmployee> 
	 ...
	 * @return List<EnterpriseEmployee>
	 */
	public int queryLoginNamePhoneExists(String phoneno) {
		Integer count = getSqlSession().selectOne("EnterpriseEmployee.queryLoginNamePhoneExists",phoneno);
		return count;
	}
	...
	public EnterpriseEmployee selectEmployeeByEnterpriseCode(String enterprisecode) throws  Exception{
		return getSqlSession().selectOne("EnterpriseEmployee.selectEmployeeByEnterpriseCode",enterprisecode);
	}
	/**
