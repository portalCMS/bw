...
public class EmployeeGamecataloyBonusDaoImpl extends BaseDaoImpl<EmployeeGamecataloyBonus> implements EmployeeGamecataloyBonusDao{
	...
	@Override
	public List<EmployeeGamecataloyBonus> selectAll(Map<String, Object> object) throws Exception {
		return getSqlSession().selectList("EmployeeGamecataloyBonus.selectAll", object);
	}
}
