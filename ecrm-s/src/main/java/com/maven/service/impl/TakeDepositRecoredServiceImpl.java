...
public class TakeDepositRecoredServiceImpl extends BaseServiceImpl<TakeDepositRecord>
	...
	public void saveingVerify(TakeDepositRecord depositeRecord, DepositWithdralOrderDelegate handles) throws Exception {
		...
		if(allmoney > depositeRecord.getOrderamount().doubleValue()) {
			...
			// 处理首存业务，如果享受到了返回true   注释因为逻辑改动，客户需求不自动进行首存赠送
			boolean result = false;//doFirstSaveing(depositeRecord, handles);//首存赠送
	...
	public static void main(String[] args) {
		String ss = "100-500:0.05";
		Map<String, Object> __object = JSONUnit.getMapFromJson("{"+ss+"}");
	...
	@Override
	public void batchRefuseOrder() {
		takeDepositRecoredDao.batchRefuseOrder();		
	}
