...
public  class LocalCache implements Cache{
	 ...
	 * 用户类型列表
	 */
	private List<EnterpriseEmployeeType> enterpriseEmployeeTypeList = new ArrayList<>();
	
	private Map<String,List<EnterpriseBannerInfo>> enterpriseBannerInfoMap = new HashMap();
	 ...
	 * 加载输出接口配置信息
	 */
	public Map<String,List<EnterpriseBannerInfo>> getEnterpriseBannerInfoMap(){
		return enterpriseBannerInfoMap;
	}
	...
	@Override
	public void setEnterpriseEmployeeType(List<EnterpriseEmployeeType> list) {
		enterpriseEmployeeTypeList.clear();
		enterpriseEmployeeTypeList.addAll(list);
	}

	@Override
	public List<EnterpriseEmployeeType> getAllEnterpriseEmployeeType() {
		return enterpriseEmployeeTypeList;
	}
}
