...
@RequestMapping("/BET67EBETSX")
@Controller
public class Betting67EbetLiveController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			Betting67EbetLiveController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	private BettingGameService<BettingBet67EbetLive> bettingGameService;
	...
	public String list(HttpServletRequest request,Model model){
		...
		return "/gamerecord/bet67/ebetlivegame";
	}
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingBet67EbetLive> list = bettingGameService.takeRecord(object);
