...
@RequestMapping("/BET67ELGDZ")
@Controller
public class Betting67ELGSlotController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			Betting67ELGSlotController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	private BettingGameService<BettingBet67ELGSlot> bettingGameService;
	...
	public String list(HttpServletRequest request,Model model){
		...
		return "/gamerecord/bet67/elgslotgame";
	}
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingBet67ELGSlot> list = bettingGameService.takeRecord(object);
