...
@RequestMapping("/NB")
@Controller
public class BettingNBController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			BettingNBController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	private BettingGameService<BettingNB> bettingGameService;
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingNB> list = bettingGameService.takeRecord(object);
