...
@RequestMapping("/HGGameLive")
@Controller
public class BettingHGGameLotteryController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			BettingHGGameLotteryController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	@Resource(name="bettingHGGameLiveServiceImpl")
	private BettingGameService<BettingHGGameLive> bettingGameService;
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingHGGameLive> list = bettingGameService.takeRecord(object);
