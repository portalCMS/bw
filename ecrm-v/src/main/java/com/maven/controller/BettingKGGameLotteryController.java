...
@RequestMapping("/KGGameLottery")
@Controller
public class BettingKGGameLotteryController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			BettingKGGameLotteryController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	private BettingGameService<BettingKGGameLottery> bettingGameService;
	...
	public String list(HttpServletRequest request,Model model){
		...
		return "/gamerecord/kglotterygame";
	}
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingKGGameLottery> list = bettingGameService.takeRecord(object);
