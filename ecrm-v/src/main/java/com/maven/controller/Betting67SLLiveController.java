...
@RequestMapping("/BET67SASX")
@Controller
public class Betting67SLLiveController extends BaseController {
	
	private static LoggerManager log = LoggerManager.getLogger(
			Betting67SLLiveController.class.getName(), OutputManager.LOG_BETTINGHQOGOG);
	...
	private BettingGameService<BettingBet67SLLive> bettingGameService;
	...
	public String list(HttpServletRequest request,Model model){
		...
		return "/gamerecord/bet67/sllivegame";
	}
	...
	public Map<String,Object> data(HttpServletRequest request , HttpServletResponse response , HttpSession session){
		try {
			...
			List<BettingBet67SLLive> list = bettingGameService.takeRecord(object);
