...
//	private BettingGameService<BettingHqNhq> bettingGameService;
	...
	private BettingGameService<BettingBet67HYLive> bettingGameService;
...
//		return "/gamerecord/nhqgame";
		return "/gamerecord/bet67/hylivegame";
	}
...
//			List<BettingHqNhq> list = bettingGameService.takeRecord(object);
			...
			List<BettingBet67HYLive> list = bettingGameService.takeRecord(object);
