          ...
          columns = [
            ...
            { title: '操作',width:'12%',sortable: false,renderer:function(value,obj){
            	...
            	if(obj.status == "1") {
					...
					if(audit_brand) {
						html += '<button type="button" onclick="showAudit(\''+ obj.lsh+'\', 0,this);" class="button  button-info botton-margin">通过</button>';
						html += '<button type="button" onclick="showAudit(\''+ obj.lsh+'\', 1,this);" class="button  button-info botton-margin">拒绝</button>';
					}
					
            	} else if(obj.status == "2") {
            		if(pay_setting) {
            			html += '<button type="button" onclick="(\''+ obj.lsh+'\', 0,this);" class="button  button-info botton-margin">发放</button>';
            		}
