               ...
               <div class="controls">
                  ...
                  <div class="control-group" id="modle1" style="display: none">
                    <label class="control-label">分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;红:</label>
                      <div class="controls">
                        <input class="input-normal control-text" type="text" value="0" name="dividend" style="width:50px;height:18px;" data-rules="{required:true,number:true,min:0,max:${sessionScope.ERCM_USER_SESSION.dividend*100 }}"/> % （最高<fmt:formatNumber type="number" value="${sessionScope.ERCM_USER_SESSION.dividend*100 }" pattern="0.00" maxFractionDigits="2"/>%）
                      </div>
                  </div>
                  <div class="control-group" id="modle2" style="display: none">
                  	<label class="control-label" >占&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;成:</label>
                      <div class="controls">
                        <input class="input-normal control-text" type="text" value="0" name="share" style="width:50px;height:18px;" data-rules="{required:true,number:true,min:0,max:${sessionScope.ERCM_USER_SESSION.share*100 }}"/> % （最高<fmt:formatNumber type="number" value="${sessionScope.ERCM_USER_SESSION.share*100 }" pattern="0.00" maxFractionDigits="2"/>%）
                      </div>
                  </div>
                  ...
                  <div class="control-group" >
                    ...
                    <div style="clear: both;">
                      <c:forEach var="game" varStatus="status" items="${games}">
                        <div class="control-group" >
                          <label class="control-label" style="color:red;width: 120px;"><b>${game.gametype.replace("Game","") }:</b></label>
                          <div class="controls">
	...
	$(function() {
		...
		BUI.use('bui/select', function(Select) {
			$.post("${ctx}/EmployeeRole/loadRoleList", function(data) {
				...
				var er_list2 = data.data.employeeRoleList;
				
				if(er_list2.length==1 && er_list2[0].rolecode =="PR000M" ){
					for (var i = 0; i < er_list.length; i++) {
						if(er_list[i].rolename =="代理" || er_list[i].rolename =="会员"){
							items.push({
