	...
	var Grid = BUI.Grid,
	  ...
	  columns = [
	     	    ...
	     	    { title : '操作',width: 250,  sortable: false,  renderer : function(value,obj){
	     	    	...
	     	    	if(sigle_delete){
		     	    	temp += '<button type="button" class="button button-danger botton-margin" onclick="deleteUserDBODomain(\''+obj.sign+'\')"><span class="icon-remove icon-white"></span>删除</button>';
	     	    	}
	     	    	if(sigle_delete){
