				...
				<form:form id="objForm" method="post" class="form-horizontal">
					<div class="control-group">
						<label class="control-label"
							style="width: 70px; text-align: left;">绑定t品牌:</label>
						<div class="controls">
...
<script type="text/javascript">
	$(function() {
		...
		bindAddClick("J_Form_Submit", "${ctx}/registerLink/addUserSiteDomain",
				form);
		$("input[name='domainclass']").on("click",function(){
			...
			if(target=="domain-enterprise"){
				if($("#enterprise_domainlink option").size()==0){
					$.ajax({
						type: "POST",
						url: "${ctx}/registerLink/takeUSAvailableDomain",
						dataType: "json",
				...
				$.ajax({
					type: "POST",
					url: "${ctx}/registerLink/takeUDefualtDomain",
					dataType: "text",
					statusCode:{404:function(){
						BUI.Message.Alert("网络异常,请求未发送成功",'error');
					}},
