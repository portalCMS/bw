  ...
  <div class="search-grid-container well">
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/KGGameLottery/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/KGGameLottery/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '游戏类型',width: '6%',  sortable: false,  dataIndex: 'gameName',
				/**
