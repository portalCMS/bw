  ...
  <div class="search-grid-container well">
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67SAFISH/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67SAFISH/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '游戏类型',width: '6%',  sortable: false,  dataIndex: 'gameCode',
				/**
