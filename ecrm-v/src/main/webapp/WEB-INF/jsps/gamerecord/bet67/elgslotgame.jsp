...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">ELG电子时差12小时，例如查询ELG电子游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67ELGDZ/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67ELGDZ/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '游戏类型 ',width: '7%',  sortable: false,dataIndex:'gameName'},
			{ title: '游戏code',width: '20%',  sortable: false,  dataIndex: 'gameCode',
				/**
