...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">三升体育时差12小时，例如查询三升体育游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67TSTY/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67TSTY/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '游戏类型',width: '10%',  sortable: false,  dataIndex: 'gamebigtype',
				/**
            ...
            { title: '投注金额',   width: '10%',  sortable: false,  summary : true, dataIndex: 'wagerStake', renderer:function(value){
        		return value.toFixed(2);
        	}},
            /* { title: '有效投注额',   width: '7%', sortable: false, summary : true,  dataIndex: 'validAmount', renderer:function(value){
            	return value.toFixed(2);
        	}}, */
            { title: '输赢金额',   width: '10%',  sortable: false, summary : true,  dataIndex: 'winAmt' , renderer:function(value){
        		if(value>0){
            ...
            { title: '投注时间',   width: '15%',  sortable: true,   dataIndex: 'betTime',renderer:BUI.Grid.Format.datetimeRenderer},
            { title: '结算时间',   width: '15%',  sortable: true,   dataIndex: 'billTime',renderer:BUI.Grid.Format.datetimeRenderer},
            { title: '下单项',   width: 100,  sortable: false,   dataIndex: 'betTypeName'},
            { title: '游戏结果',   width: 100,  sortable: false,   dataIndex: 'betStatus'},
