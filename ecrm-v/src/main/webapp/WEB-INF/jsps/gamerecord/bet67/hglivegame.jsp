  ...
  <div class="search-grid-container well">
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67HGSX/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67HGSX/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '局号', width: '11%', sortable: false,  dataIndex: 'gameId'},
           ...
           /*  { title: '有效投注额',   width: '7%', sortable: false, summary : true,  dataIndex: 'validAmount', renderer:function(value){
            ...
            { title: '输赢金额',   width: '7%',  sortable: false, summary : true,  dataIndex: 'payOut' , renderer:function(value){
        		if(value>0){
