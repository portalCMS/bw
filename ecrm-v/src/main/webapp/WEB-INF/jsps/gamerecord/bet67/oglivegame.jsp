...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">OG真人时差12小时，例如查询OG真人游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67OGSX/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67OGSX/data";
              }
    });
   }
   ...
   $(function(){
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			{ title: '投注单号', width: '9%', sortable: false,  dataIndex: 'betId'},
			{ title: '局号', width: '11%', sortable: false,  dataIndex: 'gameRoundId'},
			{ title: '用户账号',width: '7%',  sortable: false,dataIndex:'userName'},
			{ title: '游戏类型',width: '6%',  sortable: false,  dataIndex: 'gameTypeName',
				/**
            ...
            { title: '投注金额',   width: '7%',  sortable: false,  summary : true, dataIndex: 'betAmount', renderer:function(value){
        		return value.toFixed(2);
        	}},
             { title: '有效投注额',   width: '7%', sortable: false, summary : true,  dataIndex: 'validAmount', renderer:function(value){
            	return value.toFixed(2);
        	}}, 
            { title: '输赢金额',   width: '7%',  sortable: false, summary : true,  dataIndex: 'winOrLoss' , renderer:function(value){
        		if(value>0){
            ...
            { title: '投注时间',   width: '10%',  sortable: true,   dataIndex: 'betTime',renderer:BUI.Grid.Format.datetimeRenderer},
			...
			//{ title: '厅名',  width: '8%', sortable: false,  dataIndex: 'platformName'},
