...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">GD真人时差12小时，例如查询GD真人游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67GDSX/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67GDSX/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
            ...
            { title: '下单项',   width: 100,  sortable: false,   dataIndex: 'subBetType'},
