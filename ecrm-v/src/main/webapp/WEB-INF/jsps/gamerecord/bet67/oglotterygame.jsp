...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">OG彩票时差12小时，例如查询OG彩票游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67OGCP/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67OGCP/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '游戏类型',width: '10%',  sortable: false,  dataIndex: 'gameName',
				/**
            ...
            { title: '投注金额',   width: '10%',  sortable: false,  summary : true, dataIndex: 'betAmount', renderer:function(value){
             ...
             { title: '有效投注额',   width: '10%', sortable: false, summary : true,  dataIndex: 'valBetAmount', renderer:function(value){
            	return value.toFixed(2);
        	}},
