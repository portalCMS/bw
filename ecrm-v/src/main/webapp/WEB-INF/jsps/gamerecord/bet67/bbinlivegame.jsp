...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">BBIN真人时差12小时，例如查询BBIN游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67BBINSX/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67BBINSX/data";
              }
    });
   }
   ...
   $(function(){
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			{ title: '投注单号', width: '15%', sortable: false,  dataIndex: 'betId'},
			{ title: '局号', width: '11%', sortable: false,  dataIndex: 'serialId'},
			{ title: '用户账号',width: '10%',  sortable: false,dataIndex:'userName'},
			{ title: '游戏类型',width: '8%',  sortable: false,  dataIndex: 'gType',
            ...
            { title: '投注金额',   width: '9%',  sortable: false,  summary : true, dataIndex: 'betMoney', renderer:function(value){
        		return value.toFixed(2);
        	}},
            { title: '有效投注额',   width: '9%', sortable: false, summary : true,  dataIndex: 'okBetMoney', renderer:function(value){
            	return value.toFixed(2);
        	}},
            { title: '输赢金额',   width: '9%',  sortable: false, summary : true,  dataIndex: 'betResult' , renderer:function(value){
        		if(value>0){
           ...
           // { title: '结算时间',   width: '10%',  sortable: true,   dataIndex: 'billTime',renderer:BUI.Grid.Format.datetimeRenderer},
            /* { title: '下单项',   width: 100,  sortable: false,   dataIndex: 'gamebigtype'}, */
