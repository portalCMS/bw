...
<!-- 搜索页 ================================================== -->
  ...
  <div class="search-grid-container well">
    <div id="grid"><font color="red">沙龙真人时差12小时，例如查询沙龙真人游戏2018年1月1号的数据，游戏时间应设为：2018-01-01 12:00:00 到 2018-01-02 11:59:59，以此类推！</font></div>
  </div>
</div>
</body>
</html>
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/BET67SASX/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/BET67SASX/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '局号', width: '11%', sortable: false,  dataIndex: 'round'},
			{ title: '用户账号',width: '10%',  sortable: false,dataIndex:'userName'},
			{ title: '游戏类型',width: '10%',  sortable: false,  dataIndex: 'gameCode',
				/**
            ...
            { title: '输赢金额',   width: '10%',  sortable: false, summary : true,  dataIndex: 'betResult' , renderer:function(value){
        		if(value>0){
            ...
            { title: '游戏结果',   width: 100,  sortable: false,   dataIndex: 'openDetail'},
			{ title: '桌号',  width: '8%', sortable: false,  dataIndex: 'desNo'},
