  ...
  <div class="search-grid-container well">
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/YSB/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/YSB/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '下注内容',width: '7%',  sortable: false,dataIndex:'selectionPlace'},
			{ title: '盘口',width: '6%',  sortable: false,  dataIndex: 'oddFormat',
				/**
