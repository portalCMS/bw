  ...
  <div class="search-grid-container well">
   ...
   if(export_excel){
    botton_arry.push({
              ...
              handler:function(){
                searchForm.action = "${ctx}/NB/exportExcel";
                searchForm.submit();
                searchForm.action = "${ctx}/NB/data";
              }
    });
   }
	   ...
	   if(!begintime.val()&&!endtime.val()){
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '赛季',width: '15%',  sortable: false,dataIndex:'raceName'},
			{ title: '盘口',width: '15%',  sortable: false,dataIndex:'macthName'},
			{ title: '下单内容',width: '10%',  sortable: false,  dataIndex: 'optionName',
				/**
