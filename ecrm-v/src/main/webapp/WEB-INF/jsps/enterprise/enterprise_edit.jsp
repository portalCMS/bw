      ...
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                <label class="control-label" for="currencycode">当前币种:</label>
                <div class="controls">
                     <select style="width:85px;" id="currencycode" name="currencycode">
                       <option value="CNY" ${enterprise.currencycode=="CNY"?"selected='selected'":""}>CNY</option>
	                     <c:forEach items="${exchangeRateMap}" var="map">
                        	<option value="${map.key}" ${enterprise.currencycode==map.key?"selected='selected'":""}>${map.key}</option>
	                     </c:forEach>
                      </select>
                </div>
             </div>
