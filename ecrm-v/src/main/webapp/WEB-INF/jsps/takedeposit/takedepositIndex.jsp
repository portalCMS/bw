    ...
    $("#quiklychoicetime option:eq(1)").attr("selected","selected");
        	...
        	var array= new Array();
       		array.push({
                ...
                handler : function(){
                	...
                	searchForm.action = "${ctx}/takeDepositRecord/excelTakeDepositRecordAll";
                	searchForm.submit();
                	searchForm.action = "${ctx}/takeDepositRecord/findTakeDepositRecordAll";
                }
            });
       		return array;
		 }
        ...
        var Grid = BUI.Grid,
          ...
          columns = [
			...
			{ title: '订单号',   width: '15%',  sortable: false,dataIndex:'ordernumber',renderer:function(value,obj){
				if(value&&obj.orderstatus/1==4){
					return "<span style='color:red;text-decoration:line-through;'>"+value+"</span>" 
				}else{
					return value;
		    ...
		    { title: '订单金额', width: '5%', sortable: false,  dataIndex: 'orderamount', summary : true, renderer:function(value,obj){
			 ...
			 { title: '会员收付款信息', width: '10%', sortable: false,  dataIndex: 'employeepaymentaccount',renderer:function(value,obj){
				var str = obj.employeepaymentname + "<br>" + obj.bankname;
				if(value&&obj.orderstatus/1==4){
            ...
            { title: '状态',   width: '5%',  sortable: false,  dataIndex: 'orderstatus', renderer:function(value,obj){
            	if(value == "1"){
					return "审核中";
				}else if(value == "2"){
					return "审核通过";
            ...
            { title: '订单日期',width: '8%',  sortable: false,  dataIndex: 'orderdate',renderer:function(value,obj){
				if(value&&obj.orderstatus/1==4){
            ...
            { title: '处理时长',width: '7%',  sortable: false,renderer:function(value,obj){
            ...
            { title: '备注',   width: '8%',  sortable: false,   dataIndex: 'ordercomment',renderer:function(value,obj){
				if(value&&obj.orderstatus/1==4){
					return "<span style='color:red;text-decoration:line-through;'>"+value+"</span>" 
				}else{
					return value;
        ...
        var store = new Store({
            url : '${ctx}/takeDepositRecord/findTakeDepositRecordAll',
            autoLoad : false,
            pageSize:15,
            sortInfo : {
                field : 'orderdate',
