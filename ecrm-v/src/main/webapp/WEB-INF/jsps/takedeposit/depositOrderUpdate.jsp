        ...
        <hr>
            <form:form modelAttribute="takeDepositRecord" id="objForm" method="post" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-normal control-text" name="employeepaymentaccount" type="text" style="width:210px;height:18px;" data-tip="{text:'请输入银行卡号码'}" data-rules="{required:true,regexp:/^\d{4,19}$/}" maxlength="19" data-messages="{regexp:'银行卡格式有误'}" value="${order.employeepaymentaccount }"/>
                    <div class="common_mark">
                    <span id="employeeBankMsgId"></span>
                </div>
                </div>
