    ...
    <div style="position: relative;display: inline-block;">
      <div style="float: left;margin-right: 96px;">
     		 <div class="control-group span7">
                  ...
                  <select  id="employeeType" name="employeeType" style="width:85px;">
             ...
             <div class="control-group span12">
          	 ...
          	 <div style="position: absolute;right: -175px;top: 3px;">
...
var Grid = BUI.Grid,
  ...
  columns = [
	...
	{ title: '用户名',width: '10%',elCls:'center',  sortable: false,  dataIndex: 'loginaccount',renderer:function(value,obj){
		...
		}else if("代理"==obj.employeetypename){
	...
	{ title: '团队用户数t',width: '15%',elCls:'center',  sortable: false,  dataIndex: 'countMember',renderer:function(value,obj){
	...
	{ title: '分红金额',   width: '10%', elCls:'center', sortable: false,summary : true, dataIndex: 'dividend',renderer:function(value,obj){
		return value==null?"0.00":value.toFixed(2);
	}},
    { title: '占成金额',   width: '10%', elCls:'center', sortable: false,summary : true, dataIndex: 'share',renderer:function(value,obj){
		return value==null?"0.00":value.toFixed(2);
	}},
    { title: '用户输赢金额',   width: '10%', elCls:'center', sortable: false,summary : true, dataIndex: 'user_lose_win_amount',renderer:function(value){
		if((value+"").indexOf("-")<0){
			return "<span style='color:#29B529;font-size:medium;'>"+value.toFixed(2)+"</span>";
		}else{
			return "<span style='color:red;font-size:medium;'>"+value.toFixed(2)+"</span>";			
		}
	}}
  ];

var store = new Store({
    url : '${ctx}/report/queryUserLoseWinCountNew',
    autoLoad:false, 
    pageSize:15
  }),
  grid = new Grid.Grid({
