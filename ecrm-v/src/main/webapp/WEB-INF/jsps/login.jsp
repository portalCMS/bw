...
<html lang="en" style="background-color: #333;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta charset="UTF-8">
	<title>登录</title>
...
<body style="background: url(${statics}/img/login-background.jpg) no-repeat center fixed">
	<div class="login">
