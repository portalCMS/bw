...
<!-- script start --> 
    <script type="text/javascript">
      ...
      var tree = new TreeGrid({
        ...
        width:'100%',
        columns : [
          {title : '菜单名称 [菜单编码]',dataIndex :'menuname',width:'20%'},
          {title : '菜单英文名称',dataIndex :'englishname',width:'20%'},
          {title : '菜单层级',dataIndex :'menulevel',width:'5%',renderer:function(value,obj){
        	  return value+" 级菜单";
          }}, 
          {title : '访问URL',dataIndex :'menuurl',width:'25%'},
          {title : '状态',dataIndex :'menustatus',width:'5%',renderer:function(value,obj){
          	  if(value==1){
          ...
          {title : '排序',dataIndex : 'menusort',width:'5%'},
