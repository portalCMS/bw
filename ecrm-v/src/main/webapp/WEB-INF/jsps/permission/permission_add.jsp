      ...
      <div>
        ...
        <form aria-pressed="false" aria-disabled="false" id="objForm" class="form-horizontal bui-form bui-form-field-container" method="post" >
            <div class="control-group">
              ...
              <div class="controls">
              	<select aria-pressed="false" name="parentmenucode" aria-disabled="false" style="width: 200px;" class="bui-form-field-select bui-form-field bui-form-field-error" data-rules="{required:true}">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<input name="menuname" class="input-normal control-text" style="width: 174px;"  type="text" data-rules="{required:true}"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">英文标题: </label>
              <div class="controls">
              	<input name="englishname" class="input-normal control-text" style="width: 174px;"  type="text"/>
              </div>
            </div>
            <div class="control-group">
