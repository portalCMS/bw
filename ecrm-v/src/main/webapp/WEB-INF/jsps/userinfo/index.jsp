        ...
        var Grid = BUI.Grid,
          ...
          columns = [
            ...
            { title : '操作',width: 80,sortable: false,renderer : function(value,obj){
              var temp = '';
              if(unlock_bank && "1"==obj.status && (employeetype == '<%=Type.业主.value%>' || employeetype == '<%=Type.员工.value%>')){
              ...
              if(lock_bank && "2"==obj.status && (employeetype == '<%=Type.业主.value%>' || employeetype == '<%=Type.员工.value%>')){
